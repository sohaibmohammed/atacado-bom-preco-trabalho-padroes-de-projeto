#TODO: Este teste da entrega 2 foi descontinuidade devido a ser substituido pela facade com 
# os observers. Ou seja, agora notificamos diferentes partes do sistema quando uma 
#venda é realizada.
